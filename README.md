...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/CG5ZYTUQCg)
...
```sh
npx nx serve markdown-note
```

To create a production bundle:

```sh
npx nx build markdown-note
```

To see all available targets to run for a project, run:

```sh
npx nx show project markdown-note
```
